...
[![Build Status](http://build-eu-00.elastic.co/job/logstash-plugin-mixin-http_client-unit/badge/icon)](http://build-eu-00.elastic.co/job/logstash-plugin-mixin-http_client-unit/)
