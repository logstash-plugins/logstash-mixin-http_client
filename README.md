...
[![Unit Tests](https://github.com/logstash-plugins/logstash-mixin-http_client/actions/workflows/unit-tests.yml/badge.svg?branch=main)](https://github.com/logstash-plugins/logstash-mixin-http_client/actions/workflows/unit-tests.yml)
